...
public class TerrainGenerator : MonoBehaviour
{
    ...
    private delegate void OnBlockUpdated(BlockUpdateEventData block, Dictionary<Side, BlockUpdateEventData> neighbours);
    ...
    public static void InvokeBlockUpdateEvent(BlockType blockType, BlockUpdateEventData block, Dictionary<Side, BlockUpdateEventData> neighbours)
    {
    ...
    private void BuildChunk(int xPos, int zPos, NativeQueue<JobHandle> handlers, ref TerrainChunk chunk)
    {
    ...
    /// <returns></returns>
    public static int3 LocalToWorldPositionInt3(ChunkPos cp, BlockPos position)
    {
    ...
    /// <param name="position">local block position</param>
    /// <returns></returns>
    public static Vector3Int LocalToWorldPositionVector3Int(ChunkPos cp, BlockPos position)
    {
