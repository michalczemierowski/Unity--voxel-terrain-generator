        ...
        public bool GetWaterShape(BlockFace face, int3 blockPos, NativeArray<float3> verts, NativeArray<float2> uv, short sourceDistance, NativeArray<short> nearbyLiquidSourceDistance)
        {
            ...
            switch (face)
            {
                ...
                case BlockFace.FRONT:
                    ...
                    uv[0] = new Vector2(sideUVs.uv0.x, sideUVs.uv0.y + heightFront / BlockTextureSize);
                    uv[1] = sideUVs.uv1;
                    uv[2] = sideUVs.uv2;
                    uv[3] = new Vector2(sideUVs.uv3.x, sideUVs.uv0.y + heightFront / BlockTextureSize);
                ...
                case BlockFace.BACK:
                    ...
                    uv[0] = new Vector2(sideUVs.uv0.x, sideUVs.uv0.y + heightBack / BlockTextureSize);
                    uv[1] = sideUVs.uv1;
                    uv[2] = sideUVs.uv2;
                    uv[3] = new Vector2(sideUVs.uv3.x, sideUVs.uv0.y + heightBack / BlockTextureSize);
                ...
                case BlockFace.RIGHT:
                    ...
                    uv[0] = new Vector2(sideUVs.uv0.x, sideUVs.uv0.y + heightRight / BlockTextureSize);
                    uv[1] = sideUVs.uv1;
                    uv[2] = sideUVs.uv2;
                    uv[3] = new Vector2(sideUVs.uv3.x, sideUVs.uv0.y + heightRight / BlockTextureSize);
                ...
                case BlockFace.LEFT:
                    ...
                    uv[0] = new Vector2(sideUVs.uv0.x, sideUVs.uv0.y + heightLeft / BlockTextureSize);
                    uv[1] = sideUVs.uv1;
                    uv[2] = sideUVs.uv2;
                    uv[3] = new Vector2(sideUVs.uv3.x, sideUVs.uv0.y + heightLeft / BlockTextureSize);
